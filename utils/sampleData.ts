export const EXAMPLE_PRODUCT_LISTING: Record<string, Artwork> = {
  laksjflkajs232323: {
    id: "laksjflkajs232323",
    artistId: "abc123",
...
export const EXAMPLE_ARTISTS: Record<string, User> = {
  abc123: {
    id: "abc123",
